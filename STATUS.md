...
| M4 | 리더보드 실험 (API + 한국어 로컬 LLM) | 🔲 모델 확정 | [?] | ADR-0005, `docs/models.md` 14+4 |
| M5 | figure + 분석 | 🔲 | [?] | |
| M6 | 논문 초고 (Overleaf) | 🔲 | [?] | |
...
- 파일럿 생성용 API 키·모델 접근 (GPT-5.5 / Claude Sonnet 5 중 택1, HCX-007 CLOVA Studio)
