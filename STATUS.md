...
| M1 | 택소노미 v1 (Legal / Identifiability, 법령 매핑) | 🔶 초안 완료, 리뷰 대기 | 한울 → 성현 리뷰 | `taxonomy/taxonomy.yaml` v1.0-draft (38 카테고리), ADR-0004 |
...
- [ ] **성현 리뷰**: 택소노미 금융 현실성 + ADR-0004 열린 질문 5개 (dob_age·IP tier, crypto 근거, 상담내용 경계, 직원 이름)
...
- ADR-0004 택소노미 설계 accepted 여부 (열린 질문 5개)
