# 0924-01-presidio-full1440

- 담당: 한울. 실행 지원: Codex.
- 상태: **전체 1,440문서 실행·채점 완료. LLM 공통 cohort 확정 전.**
- 모델: presidio; 버전: 2.2.364.
...
- 시각: 2026-09-24T06:34:00.569407+00:00 → 2026-09-24T06:34:25.731864+00:00 (UTC).
- 경과 시간: 25.16초. 같은 호스트에서 두 baseline을 병렬 실행했으므로 단독 성능 벤치마크 시간이 아님.
...
Strict category-and-boundary micro precision=0.64422100, recall=0.05508451, F1=0.10149098.
TP=12045, FP=6652, FN=206619.
...
2. 기록된 코드/dependencies에서 `python -m src.eval.baselines --name presidio --directory <prepared-plan> --output <new-run>`으로 재현 가능합니다. 기존 공유 run을 덮어쓰지 않습니다.
